    ...
    <div class="items items_cart-mid" v-if="users.length">
      <div class="items__row items__row_header">
        <div class="items__wrap">
          ...
          <div class="items__goods">Имя</div>
          <div class="items__goods">Фамилия</div>
        </div>
        <div class="items__actions">
          <div class="items__cell items__cell_value">Роль</div>
      ...
      <template v-for="(user, i) in users">
        <div class="items__row" :key="i">
          ...
          <div class="items__actions">
            <div class="items__cell items__cell_role">
              <dropdown-select v-model="user.role" :items="roles" @input="onChangeRole(user)" />
            </div>
...
export default {
  ...
  methods: {
    onChangeRole(user) {
      const isCurrentUser = this.$store.state.auth.user._id === user._id
      console.log('onChangeRole', isCurrentUser);
      if (!isCurrentUser) {
        this.patchUser([user._id, { role: user.role }])
      }
    },
    onDeleteUser(user) {
